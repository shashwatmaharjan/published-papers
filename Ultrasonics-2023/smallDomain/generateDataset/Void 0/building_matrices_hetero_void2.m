...
%%Converting 3D to 2D:
% Q11 = 1/E_x1;
% Q12 = -(v_yx1/E_y1)+ v_zx1 - v_zy1 ;
% Q13 = v_zx1;
% Q21 = -(v_yx1/E_y1)+ v_zx1 - v_zy1 ;
% Q22 = 1/E_y1;
% Q23 = v_zy1;
% Q31 = v_zx1;
% Q32 = v_zy1;
...
%%Converting 3D to 2D:
% Q11 = 1/E_x2;
% Q12 = -(v_yx2/E_y2)+ v_zx2 - v_zy2 ;
% Q13 = v_zx2;
% Q21 = -(v_yx2/E_y2)+ v_zx2 - v_zy2 ;
% Q22 = 1/E_y2;
% Q23 = v_zy2;
% Q31 = v_zx2;
% Q32 = v_zy2;
...
%%Converting 3D to 2D:
% Q11 = 1/E_x3;
% Q12 = -(v_yx3/E_y3)+ v_zx3 - v_zy3 ;
% Q13 = v_zx3;
% Q21 = -(v_yx3/E_y3)+ v_zx3 - v_zy3 ;
% Q22 = 1/E_y3;
% Q23 = v_zy3;
% Q31 = v_zx3;
% Q32 = v_zy3;
...
for layer = 1:(number_of_layers+inclusions) %number_of_layers
    ...
    for k = 1:length(Le)
        e = Le(k);  %1:N_Ele  %CHANGE wrt layer_number
        %         Lia = ismember(e,ei);
        %         if Lia == 1
        for local_row = 1:9
            for local_col = 1:9
